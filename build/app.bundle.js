...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__http__ = __webpack_require__(309);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ui__ = __webpack_require__(310);

 //  add event listener on dom load

document.addEventListener('DOMContentLoaded', getPosts); // add event listner to post it button should create a post and also display

document.getElementById('btn-sub').addEventListener('click', submitPost); // add event listener to posts 

document.getElementById('posts').addEventListener('click', deletePost); // add event listener to posts for editing

document.getElementById('posts').addEventListener('click', editPost); // add event listener to postContainer

document.querySelector('.postsContainer').addEventListener('click', cancelPost);

function getPosts() {
  __WEBPACK_IMPORTED_MODULE_0__http__["a" /* http */].get("http://localhost:3000/posts").then(function (result) {
    __WEBPACK_IMPORTED_MODULE_1__ui__["a" /* ui */].showPosts(result);
  })["catch"](function (err) {
...
function submitPost() {
  ...
  if (title === '' || body === '') {
    __WEBPACK_IMPORTED_MODULE_1__ui__["a" /* ui */].showAlert('Please fill all the fields', 'notification is-danger');
  } else {
    if (id === '') {
      // Create Post
      __WEBPACK_IMPORTED_MODULE_0__http__["a" /* http */].create('http://localhost:3000/posts', data).then(function (data) {
        __WEBPACK_IMPORTED_MODULE_1__ui__["a" /* ui */].showAlert('Post added', 'notification is-success ');
        __WEBPACK_IMPORTED_MODULE_1__ui__["a" /* ui */].clearFields();
        getPosts();
      })["catch"](function (err) {
        return console.log(err);
      });
      ...
      // update the post
      __WEBPACK_IMPORTED_MODULE_0__http__["a" /* http */].put("http://localhost:3000/posts/".concat(id), data).then(function (data) {
        __WEBPACK_IMPORTED_MODULE_1__ui__["a" /* ui */].showAlert('Post has been updated', 'notification is-success');
        __WEBPACK_IMPORTED_MODULE_1__ui__["a" /* ui */].changeFormState('add');
        getPosts();
      })["catch"](function (err) {
        return console.log(err);
      });
...
function deletePost(e) {
  ...
  if (e.target.parentElement.classList.contains('dlt')) {
    ...
    if (confirm('Are you sure??')) {
      __WEBPACK_IMPORTED_MODULE_0__http__["a" /* http */]["delete"]("http://localhost:3000/posts/".concat(id)).then(function () {
        __WEBPACK_IMPORTED_MODULE_1__ui__["a" /* ui */].showAlert('Post removed', 'notification is-success');
        getPosts();
      })["catch"](function (err) {
        return console.log(err);
      });
...
function editPost(e) {
  ...
  if (e.target.parentElement.classList.contains('edit')) {
    var body = e.target.parentElement.previousElementSibling.childNodes[0].nextSibling.textContent;
    var title = e.target.parentElement.previousElementSibling.previousElementSibling.childNodes[0].nextSibling.textContent;
    var id = e.target.parentElement.dataset.id;
    var data = {
      id: id,
      title: title,
    ...
    __WEBPACK_IMPORTED_MODULE_1__ui__["a" /* ui */].fillForm(data);
  }
...
var easyHTTP = /*#__PURE__*/function () {
  ...
  _createClass(easyHTTP, [{
    ...
    key: "create",
    value: function () {
      var _create = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(url, data, callback) {
        var response, resData;
    ...
    key: "put",
    value: function () {
      var _put = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(url, data, callback) {
        var response, resData;
    ...
    key: "delete",
    value: function () {
      var _delete2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(url, callback) {
        var response, resData;
...
var UI = /*#__PURE__*/function () {
  ...
  _createClass(UI, [{
    ...
    value: function showAlert(message, className) {
      ...
      this.clearAlert(); // create a div

      var div = document.createElement('div');
      div.className = className; // append text to div

      div.appendChild(document.createTextNode(message));
      var container = document.querySelector('.postsContainer'); //  insert the div
    ...
    value: function clearAlert() {
      var currAlert = document.querySelector('.notification');
    ...
    value: function changeFormState(type) {
      if (type === 'edit') {
        ...
        this.subBtn.classList.add('is-black'); // Create cancel button
